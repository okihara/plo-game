...
const PRESET_AVATARS = [
  ...Array.from({ length: 38 }, (_, i) => `/images/icons/icon_${String(i + 1).padStart(3, '0')}.png`),
  '/images/icons/icon_anime.png',
  '/images/icons/icon_cosmic.png',
  '/images/icons/icon_cyber.png',
  '/images/icons/icon_geometric.png',
  '/images/icons/icon_lion.png',
  '/images/icons/icon_luxury.png',
  '/images/icons/icon_nightcity.png',
  '/images/icons/icon_shadow.png',
  '/images/icons/icon_stoic.png',
  '/images/icons/icon_street.png',
];
...
function ProfileEditDialog({
  ...
  return (
    ...
    >
      <div className="@container w-[80cqw]">
        <div className="bg-white rounded-[5cqw] p-[6cqw] border border-cream-300 shadow-[0_8px_40px_rgba(139,126,106,0.3)] animate-scale-in relative max-h-[80dvh] overflow-y-auto">
          {/* Close */}
          <button
            onClick={onClose}
            className="absolute top-[3cqw] right-[3cqw] text-cream-400 hover:text-cream-900 text-[7cqw] leading-none"
          ...
          <h2 className="text-[4.5cqw] font-bold text-cream-900 mb-[4cqw]">プロフィール編集</h2>
          ...
          {/* Avatar Selection */}
          <div className="mb-[4cqw]">
            <label className="text-cream-600 text-[3cqw] mb-[2cqw] block">アイコン</label>
            ...
            <p className="text-cream-500 text-[2.5cqw] mt-[2cqw]">次回着席時から反映</p>
          </div>
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="w-full py-[2.5cqw] bg-cream-900 text-white text-[3.5cqw] font-semibold rounded-[3cqw] hover:bg-cream-800 disabled:opacity-50 transition-colors"
          >
            {saving ? '保存中...' : '保存'}
          </button>
        </div>
