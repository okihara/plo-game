  ...
  return (
    <div className="h-full w-full light-bg flex items-center justify-center p-4">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-cream-900 mb-1"><BrandText /></h1>
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <span className="text-cream-700">{blindsLabel}</span>
        </div>
        <div className="animate-spin rounded-full h-10 w-10 border-2 border-cream-300 border-t-forest mx-auto mb-4"></div>
        <p className="text-cream-700">サーバーに接続中...</p>
        <button
          onClick={onCancel}
          className="mt-6 text-cream-700 hover:text-cream-900 text-sm transition-colors"
        >
          キャンセル
        </button>
      </div>
