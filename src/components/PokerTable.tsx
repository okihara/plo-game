...
export function PokerTable({
  ...
  return (
    <div className="flex-1 relative flex items-center justify-center p-2.5 min-h-0">
      ...
      <div className="h-[95%] aspect-[0.7] bg-[radial-gradient(ellipse_at_center,#1e5631_0%,#145028_50%,#0d3d1c_100%)] rounded-[45%] border-[0.5vh] border-[#2a1810] shadow-[0_0_0_0.3vh_#4a3020,0_0_2vh_rgba(0,0,0,0.5),inset_0_0_4vh_rgba(0,0,0,0.3)] relative">
        {/* Pot Display */}
