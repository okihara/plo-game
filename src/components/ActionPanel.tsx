    ...
    <div className="bg-gradient-to-b from-white/90 to-white/80 px-[1.5vh] pt-[1.5vh] pb-[1vh] border-t-2 border-pink-300 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-3 gap-[1vh]">
        <button
          ...
          disabled={!isMyTurn}
          className="py-[1.8vh] px-[1vh] rounded-xl text-[1.5vh] font-bold uppercase tracking-wide transition-all active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed bg-gradient-to-b from-gray-400 to-gray-500 text-white shadow-md"
        >
          フォールド
        </button>
        <button
