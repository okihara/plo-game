...
const COOLDOWN_MINUTES = parseFloat(process.env.BOT_COOLDOWN_MINUTES || '5');
...
console.log(`Session limit: ${MAX_HANDS_PER_SESSION} hands, cooldown: ${COOLDOWN_MINUTES}min`);
